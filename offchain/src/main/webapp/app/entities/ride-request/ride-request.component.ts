...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/ride-request'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: RideRequest) {
        return item.id;
    }
    registerChangeInRideRequests() {
        this.eventSubscriber = this.eventManager.subscribe('rideRequestListModification', (response) => this.loadAll());
    }
