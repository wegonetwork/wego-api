package network.wego.config.social;

import network.wego.repository.SocialUserConnectionRepository;
import network.wego.repository.CustomSocialUsersConnectionRepository;
import network.wego.security.jwt.TokenProvider;
import network.wego.security.social.CustomSignInAdapter;
