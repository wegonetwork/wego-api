...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/ride-offer'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: RideOffer) {
        return item.id;
    }
    registerChangeInRideOffers() {
        this.eventSubscriber = this.eventManager.subscribe('rideOfferListModification', (response) => this.loadAll());
    }
